      ...
      <section id="home">
        <div className="right">
          ...
          <p>
            ...
            user-friendly designs. Specializing in modern web technologies to
        ...
        <div className="project-cards">
          <div className="project-card">
            ...
            <p>
              ...
              remaining balances, and profit or loss. It automatically
              calculates the day's figures and generates a clear breakdown of
              the results.
            </p>
          ...
          <div className="project-card">
            ...
            <p>Binge Tracker</p>
            <p>
              Binge Tracker is a simple web app for keeping track of TV shows
              and episodes watched. Users can add shows, record episode counts,
              search their watchlist, and monitor their overall viewing
              progress.
            </p>
          ...
          <div className="project-card">
            ...
            <p>
              ...
              management platform I built specifically for campus and
              small-scale events. It bridges the gap between organizers and
              attendees by providing a seamless, all-in-one solution for
              creating, promoting, and booking events.
            </p>
          ...
          <div className="project-card">
            ...
            <p>Weather App</p>
            <p>
              A responsive weather application that allows users to search for
              any city and view real-time weather information such as
              temperature, weather conditions, humidity, and wind speed. The app
              fetches live data from a weather API and presents it in a clean
